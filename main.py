...
class RemoveBGApp:
    def __init__(self, root):
        ...
        # === TOMBOL-TOMBOL ===
        tk.Button(
            main_frame, text="📂 Buka Gambar", command=self.open_image,
            bg="#42a5f5", fg="white", font=("Segoe UI", 10, "bold"),
            width=20, relief="flat"
        ).grid(row=2, column=0, padx=10, pady=5)

        tk.Button(
            main_frame, text="🧹 Hapus Background", command=self.remove_bg,
            bg="#66bb6a", fg="white", font=("Segoe UI", 10, "bold"),
            width=20, relief="flat"
        ).grid(row=2, column=1, padx=10, pady=5)

        tk.Button(
            main_frame, text="💾 Simpan Gambar", command=self.save_image,
            bg="#ffa726", fg="white", font=("Segoe UI", 10, "bold"),
            width=20, relief="flat"
